...
#define STRING_CONFIG_H_AUTHOR "(Matosantos)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Anet ET4 Mods"
...
#define BIGTREE_TFT24_V1_1
#define DISPLAY_TYPE BIGTREE_TFT24
